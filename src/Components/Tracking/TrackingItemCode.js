...
class TrackingItemCode extends Component {
    constructor(props) {
        super(props);
        this.state = {
            item_code: '',
                ...
                .then((resp) => {
                    if (resp.status === '200') {
                        ...
                        if (initailData[1].length > 0) {
                            ...
                            result['challan_date'] = initailData[1][0].date1;
                        }
                        ...
                        confirmAlert({
                            ...
                            buttons: [
                                {
                                    label: 'Okay',
                                    onClick: () => this.setState({ item_code: '' })
                                },
...
export default TrackingItemCode;